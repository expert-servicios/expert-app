create unique index if not exists internal_tasks_one_open_nationality_review_per_case
...
begin
  ...
  insert into public.internal_tasks (
    ...
    'Pago confirmado. Revisar documentación inicial, validar 1 año de residencia legal del menor y la viabilidad antes de abonar el suplido 790-026.',
    'pendiente',
    'alta',
    v_case_id,
    new.client_id,
