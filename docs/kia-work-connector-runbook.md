...
Estado: preparado para revisión, pendiente de migración y activación. No es un webhook nativo de Work. Diseño completo: [orquestación de expedientes](kia-work-case-orchestration.md).
...
1. Ensayar y aplicar `20260924093629_kia_work_case_orchestration.sql` después de las migraciones anteriores. No cambia estados de expedientes ni envía mensajes.
