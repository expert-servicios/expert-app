...
- rechaza `integrationId` vacío antes de resolver credenciales para impedir fallback accidental a la cuenta global EXPERT;
- únicamente métodos `GET`;
- timeout de 20 segundos;
- paginación por cursor;
- límite máximo de página 200;
- limitador de frecuencia con reserva secuencial de slots para que llamadas concurrentes no salgan en ráfaga;
...
Estado: implementación endurecida sobre `main` posterior a KIA M7.2d.
