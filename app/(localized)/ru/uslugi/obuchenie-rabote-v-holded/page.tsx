...
const SERVICE_SLUG = 'formacion-holded';
const ES_URL = 'https://expertconsulting.es/servicios/formacion/formacion-holded';
const RU_PATH = '/ru/uslugi/obuchenie-rabote-v-holded';
...
if (!getCatalogService(SERVICE_SLUG)) {
  throw new Error('Canonical formacion-holded service is missing from the catalog.');
}

const PRICE_RU = '180 € + IVA / блок 2 часа';
...
export const metadata: Metadata = {
  title: 'Обучение работе в Holded — практическая сессия | EXPERT',
  description:
    `Как Holded Solution Partner проводим практическое обучение работе в Holded: счета, бухгалтерия, склад, проекты и CRM. ${PRICE_RU}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Обучение по Holded | EXPERT',
    description: 'Практика на вашем аккаунте Holded по нужным вам модулям.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Практическая сессия на вашем собственном аккаунте Holded',
  'Обзор используемых вами модулей',
  'Настройка базовых автоматизаций',
  'Персональная инструкция по использованию',
  'Поддержка по email после сессии (7 дней)',
];

const faqs = [
  {
    q: 'Нужна ли уже подключённая подписка Holded для обучения?',
    a: 'Да, мы работаем непосредственно с вашим аккаунтом. Если у вас ещё нет Holded, мы можем сначала помочь с его настройкой.',
  },
  {
    q: 'Сколько блоков обучения мне понадобится?',
    a: 'Зависит от модуля. Для базового выставления счетов обычно достаточно 1–2 блоков. Для полной бухгалтерии — 3–4 блока.',
  },
];

export default function RuFormacionHoldedPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Обучение работе в Holded',
    description:
      'Как Holded Solution Partner проводим целевое обучение работе в Holded: модули выставления счетов, бухгалтерии, склада, проектов и CRM. Сессии по 2 часа, адаптированные под уровень и реальный сценарий использования клиента.',
    serviceType: 'Holded',
    provider: {
      '@type': 'Organization',
      name: 'EXPERT',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Обучение работе в Holded
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Как Holded Solution Partner мы проводим целевое обучение работе в Holded: модули выставления
            счетов, бухгалтерии, склада, проектов и CRM. Сессии по 2 часа, адаптированные под ваш уровень
            и реальный сценарий использования.
          </p>
