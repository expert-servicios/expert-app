...
const SERVICE_SLUG = 'irpf';
const ES_URL = 'https://expertconsulting.es/servicios/declaraciones-impuestos/irpf';
const RU_PATH = '/ru/uslugi/deklaratsiya-o-dohodah-irpf';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Декларация о доходах (IRPF) | EXPERT',
    description: 'Проверка налоговой ситуации, вычеты, черновик декларации и подача в AEAT.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Полная проверка налоговых данных',
  'Определение применимых вычетов и льгот',
  'Подготовка и согласование черновика декларации',
...
const faqs = [
  {
    q: 'Нужно ли куда-то приезжать?',
    a: 'Нет. Весь процесс проходит онлайн. Вы присылаете документы, а мы занимаемся подготовкой и подачей декларации.',
  },
  {
    q: 'Какие документы нужно предоставить?',
    a: 'DNI/NIE, номер референции AEAT или Cl@ve, справки об удержаниях, данные о недвижимости, кредитах и инвестициях — если они у вас есть.',
  },
  {
    q: 'Когда начинается кампания по декларации о доходах?',
    a: 'Кампания IRPF стартует в апреле и завершается в конце июня. Рекомендуем не откладывать подачу на последний момент, чтобы избежать перегрузки системы.',
  },
];

export default function RuIrpfPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Декларация о доходах (IRPF)',
    description:
      'Полное сопровождение декларации о доходах: проверка налоговой ситуации, вычеты, подготовка черновика и подача в AEAT.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Декларация о доходах (IRPF)
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Ведём декларацию о доходах от начала до конца: проверяем вашу налоговую ситуацию,
            определяем применимые вычеты, готовим черновик декларации, согласовываем его с вами
            и подаём в AEAT. Услуга подходит резидентам, наёмным работникам, autónomos и владельцам недвижимости.
          </p>
