...
const SERVICE_SLUG = 'formacion-laboral-rrhh';
const ES_URL = 'https://expertconsulting.es/servicios/formacion/formacion-laboral-rrhh';
const RU_PATH = '/ru/uslugi/obuchenie-po-trudovomu-pravu-i-kadram';
...
if (!getCatalogService(SERVICE_SLUG)) {
  throw new Error('Canonical formacion-laboral-rrhh service is missing from the catalog.');
}
...
export const metadata: Metadata = {
  title: 'Обучение по трудовому праву и кадрам — практические занятия | EXPERT',
  description:
    `Практическое обучение по трудовым договорам, зарплате, приёму и увольнению сотрудников для административных и HR-команд. ${PRICE_RU}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Обучение: трудовое право и кадры | EXPERT',
    description: 'Договоры, зарплата, приём и увольнение сотрудников — на практике.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  ...
  'Практические кейсы по кадровому управлению',
  'Разбор вопросов',
  'Доступ к шаблонам и типовым формам',
];

const faqs = [
  {
    q: 'Подходит ли обучение людям без опыта в HR?',
    a: 'Да, мы адаптируем уровень сложности под участника.',
  },
];

export default function RuFormacionLaboralRrhhPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Обучение по трудовому праву и кадровому делу',
    description:
      'Практическое обучение для руководителей административных отделов, менеджеров и HR-команд: виды трудовых договоров, расчёт зарплаты, постановка на учёт и снятие с учёта в Seguridad Social, учёт отсутствий, увольнения и кадровая документация.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Обучение по трудовому праву и кадровому делу
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Практическое обучение для руководителей административных отделов, менеджеров и HR-команд: виды
            трудовых договоров, расчёт зарплаты, постановка на учёт и снятие с учёта в Seguridad Social,
            учёт отсутствий, увольнения и кадровая документация.
          </p>
