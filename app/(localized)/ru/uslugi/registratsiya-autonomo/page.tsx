...
const SERVICE_SLUG = 'alta-autonomo';
const ES_URL = 'https://expertconsulting.es/servicios/empresas-autonomos/alta-autonomo';
const RU_PATH = '/ru/uslugi/registratsiya-autonomo';
...
const service = (() => {
  ...
  if (!canonical?.stripePriceId || !canonical.price) {
    throw new Error('Canonical alta-autonomo service is not configured for checkout.');
  }
  return {
    ...canonical,
...
export const metadata: Metadata = {
  title: 'Регистрация autónomo в Испании — Modelo 036 и RETA | EXPERT',
  description:
    `Регистрация autónomo: постановка на учёт в Hacienda (Modelo 036) и в RETA, консультация по эпиграфу деятельности, tarifa plana и налоговым обязанностям. ${service.price}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Регистрация autónomo в Испании | EXPERT',
    description: 'Modelo 036, RETA, эпиграф деятельности, tarifa plana и обязанности autónomo с первого дня.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const DURATION_RU = '1–3 рабочих дня';

const includes = [
  'Modelo 036 — постановка на налоговый учёт в Hacienda',
  'Регистрация в RETA (Seguridad Social)',
  'Консультация по эпиграфу деятельности и базе начисления взносов',
  'Информация о tarifa plana и льготах',
  'Руководство по налоговым обязанностям autónomo',
];

const faqs = [
  {
    q: 'Сколько занимает регистрация?',
    a: 'Постановка на налоговый учёт происходит сразу. Регистрация в RETA может занять 1–3 дня.',
  },
  {
    q: 'Какой будет взнос autónomo?',
    a: 'В 2026 году взнос зависит от диапазона чистого дохода, выбранной внутри диапазона базы и применимых ставок. Мы рассчитываем его по действующей официальной таблице, а не по усреднённому ориентиру.',
  },
];

export default function RuAltaAutonomoPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Регистрация autónomo в Испании',
    description:
      'Постановка на учёт в качестве autónomo: Modelo 036 в Hacienda, регистрация в RETA, консультация по эпиграфу деятельности, базе начисления, tarifa plana и льготам.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Регистрация autónomo в Испании
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Ставим вас на учёт как autónomo: Modelo 036 в Hacienda и регистрация в RETA, с консультацией
            по подходящему эпиграфу деятельности, базе начисления, tarifa plana и льготам с первого дня.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            />
            <Link
              href="/solicitar-presupuesto?servicio=alta-autonomo&tipo=caso-complejo"
