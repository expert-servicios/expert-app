...
const SERVICE_SLUG = 'formacion-fiscal-contable';
const ES_URL = 'https://expertconsulting.es/servicios/formacion/formacion-fiscal-contable';
const RU_PATH = '/ru/uslugi/obuchenie-po-nalogam-i-buhuchetu';
...
if (!getCatalogService(SERVICE_SLUG)) {
  throw new Error('Canonical formacion-fiscal-contable service is missing from the catalog.');
}
...
export const metadata: Metadata = {
  title: 'Обучение по налогам и бухучёту — практические занятия | EXPERT',
  description:
    `Практическое обучение по IRPF, IVA, закрытию отчётного периода, налоговым формам и планированию для autónomo, бизнеса и административных команд. ${PRICE_RU}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Обучение: налоги и бухучёт | EXPERT',
    description: 'Практика по IRPF, IVA, закрытию периода и декларациям — блоками по 2 часа.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Сессия онлайн или очно (по договорённости)',
  'Учебные материалы и письменное резюме',
  'Практические упражнения на реальных примерах',
  'Разбор вопросов в прямом эфире',
  'Запись сессии (если формат онлайн)',
];

const faqs = [
  {
    q: 'Можно ли заказать обучение по конкретной теме?',
    a: 'Да. Программа адаптируется под ваши конкретные задачи: закрытие налогового периода, IVA при импорте, IRPF для экспатов и т. д.',
  },
  {
    q: 'Можно ли провести обучение для команды?',
    a: 'Да, мы можем адаптировать содержание и формат для команды до 10 человек.',
  },
];

export default function RuFormacionFiscalContablePage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Обучение по налогам и бухучёту',
    description:
      'Практическое обучение по вопросам налогообложения и бухгалтерского учёта для autónomo, малого и среднего бизнеса и административных команд: IRPF, IVA, закрытие бухгалтерского периода, налоговые формы, декларации и налоговое планирование.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Обучение по налогам и бухучёту
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Проводим практическое обучение по вопросам налогообложения и бухгалтерского учёта для autónomo,
            малого и среднего бизнеса и административных команд: IRPF, IVA, закрытие бухгалтерского периода,
            налоговые формы (modelos), декларации и налоговое планирование.
          </p>
