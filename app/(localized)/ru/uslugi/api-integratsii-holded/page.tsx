...
const SERVICE_SLUG = 'holded-integraciones-api';
const ES_URL = 'https://expertconsulting.es/servicios/holded/holded-integraciones-api';
const RU_PATH = '/ru/uslugi/api-integratsii-holded';
...
const service = (() => {
  ...
  if (!canonical?.stripePriceId || !canonical.price) {
    throw new Error('Canonical holded-integraciones-api service is not configured for checkout.');
  }
  return {
    ...canonical,
...
const DURATION_RU = 'Зависит от объёма работ';
...
export const metadata: Metadata = {
  title: 'API-интеграции Holded | EXPERT',
  description:
    `Подключаем Holded к вашим внешним инструментам через официальный API: интернет-магазин, CRM, платёжные платформы и другое ПО. ${service.price}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'API-интеграции Holded | EXPERT',
    description: 'Подключение Holded к вашим сервисам через официальный API.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Анализ реализуемости интеграции',
  'Разработка коннектора или автоматизации',
  'Тестирование работы в реальной среде',
  'Базовая документация по интеграции',
  'Техническая поддержка в течение 15 дней',
];

const faqs = [
  {
    q: 'Какие сервисы можно интегрировать?',
    a: 'Любой сервис с REST API. Наиболее частые: WooCommerce, Shopify, Stripe, HubSpot, Zapier, Google Sheets и инструменты BI.',
  },
  {
    q: 'Цена фиксирована для любой интеграции?',
    a: 'Базовая цена — 180 €. Если интеграция особенно сложная, мы заранее рассчитаем и согласуем разницу в стоимости.',
  },
];

export default function RuHoldedIntegracionesApiPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'API-интеграции Holded',
    description:
      'Подключение Holded к внешним инструментам через официальный API: интернет-магазин, CRM, платёжные платформы, инструменты BI или любое используемое клиентом ПО. Включает анализ реализуемости, разработку коннектора и тестирование интеграции.',
    serviceType: 'Holded',
    provider: {
      '@type': 'Organization',
      name: 'EXPERT',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            API-интеграции Holded
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Подключаем Holded к вашим внешним инструментам через официальный API: интернет-магазин,
            CRM, платёжные платформы, инструменты BI или любое используемое вами ПО. Включает анализ
            реализуемости, разработку коннектора и тестирование интеграции.
          </p>
