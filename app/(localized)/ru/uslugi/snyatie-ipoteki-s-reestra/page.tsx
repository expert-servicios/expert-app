...
const SERVICE_SLUG = 'hipoteca-cancelacion';
const ES_URL = 'https://expertconsulting.es/servicios/notaria-propiedades/hipoteca-cancelacion';
const RU_PATH = '/ru/uslugi/snyatie-ipoteki-s-reestra';
...
const service = (() => {
  ...
  if (!canonical) {
    throw new Error('Canonical hipoteca-cancelacion service is missing from the catalog.');
  }
  return canonical;
})();
...
export const metadata: Metadata = {
  title: 'Снятие ипотеки с регистрации в Испании | EXPERT',
  description:
    `Снятие ипотечного обременения с Registro de la Propiedad после погашения кредита: банковские документы, нотариальный акт и подача в реестр. ${service.price}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Снятие ипотеки с регистрации | EXPERT',
    description: 'Справка банка, нотариальный акт и снятие обременения с недвижимости.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Получение банковской справки об отсутствии задолженности (saldo cero)',
  'Нотариальный акт о снятии обременения',
  'Подача документов в Registro de la Propiedad',
  'Получение обновлённой nota simple (выписки из реестра)',
];

const faqs = [
  {
    q: 'Почему ипотека всё ещё отображается в реестре, если кредит уже погашен?',
    a: 'Потому что погашение долга и снятие обременения с реестра — это два разных юридических действия. Для снятия обременения нужен нотариальный акт от банка-кредитора и подача документов в Registro de la Propiedad — автоматически это не происходит.',
  },
];

export default function RuHipotecaCancelacionPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Снятие ипотеки с регистрации (cancelación de hipoteca)',
    description:
      'Снятие ипотечного обременения с Registro de la Propiedad после полного погашения кредита: банковские документы, нотариальный акт о снятии обременения и подача в реестр.',
    serviceType: 'Notaría y Propiedades',
    provider: {
      '@type': 'Organization',
      name: 'EXPERT',
    },
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Снятие ипотеки с регистрации
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            После погашения ипотечного долга обременение не исчезает из Registro de la Propiedad автоматически.
            Мы оформляем банковские документы, нотариальный акт о снятии обременения, льготную самоуплату налога
            (autoliquidación exenta), если она применима, и подаём документы в реестр.
          </p>
