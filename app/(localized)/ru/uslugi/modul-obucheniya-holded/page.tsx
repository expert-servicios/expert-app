...
const SERVICE_SLUG = 'holded-modulo-formacion';
const ES_URL = 'https://expertconsulting.es/servicios/holded/holded-modulo-formacion';
const RU_PATH = '/ru/uslugi/modul-obucheniya-holded';
...
const service = (() => {
  ...
  if (!canonical?.stripePriceId || !canonical.price) {
    throw new Error('Canonical holded-modulo-formacion service is not configured for checkout.');
  }
  return {
    ...canonical,
...
export const metadata: Metadata = {
  title: 'Модуль обучения Holded — практическая сессия | EXPERT',
  description:
    `Как Holded Solution Partner проводим 2-часовое практическое обучение по модулям Holded, которые вы используете. ${service.price}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Модуль обучения Holded | EXPERT',
    description: '2 часа практики по видеосвязи, адаптированные под модули, которые вы используете.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Практическая сессия 2 часа по видеосвязи',
  'Адаптирована под используемые вами модули',
  'Запись сессии включена',
  'Поддержка по email после сессии (7 дней)',
  'Бронирование времени после оплаты',
];

const faqs = [
  {
    q: 'Можно ли заказать обучение по конкретной теме?',
    a: 'Да. Вы сообщаете, по какому модулю нужно обучение, и мы адаптируем содержание.',
  },
  {
    q: 'Сколько сессий мне понадобится?',
    a: 'Зависит от модуля. Для базового выставления счетов обычно достаточно одной. Для полной бухгалтерии — 3–4 блока.',
  },
];

export default function RuHoldedModuloFormacionPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Модуль обучения Holded',
    description:
      'Целевое обучение по модулям Holded, которые использует клиент: выставление счетов, бухгалтерия, склад, проекты или CRM. Сессия 2 часа по видеосвязи, с записью.',
    serviceType: 'Holded',
    provider: {
      '@type': 'Organization',
      name: 'EXPERT',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Модуль обучения Holded
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Как Holded Solution Partner мы проводим целевое обучение по тем модулям Holded, которые вы
            используете: выставление счетов, бухгалтерия, склад, проекты или CRM. Сессия длится 2 часа
            по видеосвязи, запись включена.
          </p>
        ...
        <aside className="space-y-5 lg:sticky lg:top-6">
          <div className="overflow-hidden border border-[#D4A017]/30 bg-white">
            <div className="border-b border-[#D4A017]/20 bg-[#D4A017]/8 px-6 py-4">
              ...
              <p className="mt-2 text-xs leading-5 text-[#23364D]/65">Длительность: {service.duration}.</p>
            </div>
