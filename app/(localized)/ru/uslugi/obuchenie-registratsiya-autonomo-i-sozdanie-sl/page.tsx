...
const SERVICE_SLUG = 'formacion-alta-autonomo-sl';
const ES_URL = 'https://expertconsulting.es/servicios/formacion/formacion-alta-autonomo-sl';
const RU_PATH = '/ru/uslugi/obuchenie-registratsiya-autonomo-i-sozdanie-sl';
...
if (!getCatalogService(SERVICE_SLUG)) {
  throw new Error('Canonical formacion-alta-autonomo-sl service is missing from the catalog.');
}
...
export const metadata: Metadata = {
  title: 'Обучение: регистрация autónomo и создание SL | EXPERT',
  description:
    `Практическое обучение для тех, кто начинает деятельность: autónomo или SL, налоги, взносы, счета и IVA. ${PRICE_RU}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Обучение: autónomo и SL | EXPERT',
    description: 'С чего начать: autónomo или SL, налоги, взносы и счета.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'autónomo vs. SL: когда что выбрать',
  'Налоговые обязанности и обязанности перед Seguridad Social с первого дня',
  'Как выставлять счета и вести учёт IVA',
  'Взнос autónomo (cuota de autónomos) и минимальная база начисления',
  'Частые вопросы первого года деятельности',
];

const faqs = [
  {
    q: 'Подходит ли обучение тем, кто ещё не начал деятельность?',
    a: 'Да, курс рассчитан на тех, кто находится на подготовительном этапе или только что зарегистрировался и хочет разобраться во всём с нуля.',
  },
  {
    q: 'Включает ли обучение персональную консультацию?',
    a: 'Сессия носит обучающий характер, но вы можете озвучить свою конкретную ситуацию и получить рекомендации прямо на занятии.',
  },
];

export default function RuFormacionAltaAutonomoSlPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Обучение: регистрация autónomo и создание SL',
    description:
      'Практическое обучение для предпринимателей и специалистов, которые собираются начать деятельность: различия между статусом autónomo и Sociedad Limitada (SL), налоговые обязанности с первого дня, взносы в Seguridad Social, выставление счетов, IVA и базовый учёт.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Обучение: регистрация autónomo и создание SL
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Практическое обучение для предпринимателей и специалистов, которые собираются начать
            деятельность: различия между статусом autónomo и Sociedad Limitada (SL), налоговые обязанности
            с первого дня, взносы в Seguridad Social, выставление счетов, IVA и базовый учёт.
          </p>
