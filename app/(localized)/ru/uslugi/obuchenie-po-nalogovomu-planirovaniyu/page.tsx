...
const SERVICE_SLUG = 'formacion-planificacion-fiscal';
const ES_URL = 'https://expertconsulting.es/servicios/formacion/formacion-planificacion-fiscal';
const RU_PATH = '/ru/uslugi/obuchenie-po-nalogovomu-planirovaniyu';
...
if (!getCatalogService(SERVICE_SLUG)) {
  throw new Error('Canonical formacion-planificacion-fiscal service is missing from the catalog.');
}
...
export const metadata: Metadata = {
  title: 'Обучение по налоговому планированию — практические занятия | EXPERT',
  description:
    `Практическое обучение по оптимизации налоговой нагрузки: вычеты, вознаграждение партнёра, пенсионные планы и закрытие года. ${PRICE_RU}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Обучение: налоговое планирование | EXPERT',
    description: 'Вычеты, вознаграждение партнёра и закрытие налогового года.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Реальные вычитаемые расходы против риска налоговой проверки',
  'Вознаграждение управляющего партнёра: зарплата или дивиденды',
  'Взносы в пенсионные планы и их налоговый эффект',
  'Закрытие налогового года в декабре: что можно сделать до нового года',
  'Практические кейсы, адаптированные под вашу ситуацию',
];

const faqs = [
  {
    q: 'Будет ли полезно, если я уже несколько лет работаю как autónomo?',
    a: 'Особенно полезно. Многие autónomo не используют все доступные вычеты или допускают ошибки, которые приводят к налоговым проверкам.',
  },
  {
    q: 'Могу ли я сразу применить полученные знания?',
    a: 'Да. Обучение практическое, и его можно применять с первого дня.',
  },
];

export default function RuFormacionPlanificacionFiscalPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Обучение по налоговому планированию',
    description:
      'Практическое обучение по налоговому планированию и оптимизации для autónomo и малого и среднего бизнеса: снижение налогооблагаемой базы по IRPF, вычитаемые расходы, оптимальное вознаграждение управляющего партнёра, пенсионные планы, налогообложение дивидендов и стратегии закрытия налогового года.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Обучение по налоговому планированию
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Практическое обучение по налоговому планированию и оптимизации для autónomo и малого и
            среднего бизнеса: снижение налогооблагаемой базы по IRPF, вычитаемые расходы, оптимальное
            вознаграждение управляющего партнёра, пенсионные планы, налогообложение дивидендов и стратегии
