...
const SERVICE_SLUG = 'holded-migracion-con-inventario';
const ES_URL = 'https://expertconsulting.es/servicios/holded/holded-migracion-con-inventario';
const RU_PATH = '/ru/uslugi/migratsiya-v-holded-s-inventarizatsiey';
...
const service = (() => {
  ...
  if (!canonical?.stripePriceId || !canonical.price) {
    throw new Error('Canonical holded-migracion-con-inventario service is not configured for checkout.');
  }
  return {
    ...canonical,
...
export const metadata: Metadata = {
  title: 'Миграция в Holded с инвентаризацией | EXPERT',
  description:
    `Полный перенос в Holded с модулем склада: товары, склады, остатки и интеграция склада со счетами. ${service.price}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Миграция в Holded с инвентаризацией | EXPERT',
    description: 'Товары, склады, начальные остатки и интеграция склада с выставлением счетов.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Всё из миграции без модуля склада',
  'Перенос товаров и артикулов',
  'Настройка складов и начальных остатков',
  'Интеграция склада с выставлением счетов',
  'Приоритетная поддержка в течение 90 дней',
];

const faqs = [
  {
    q: 'Что такое интеграция склада с выставлением счетов?',
    a: 'Мы настраиваем Holded так, чтобы при выставлении счета остаток товара автоматически списывался, а при поступлении товара — обновлялся.',
  },
  {
    q: 'Сколько это занимает?',
    a: 'От 4 до 6 недель. Модуль склада требует больше времени на загрузку и проверку данных.',
  },
];

export default function RuHoldedMigracionConInventarioPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Миграция в Holded с инвентаризацией',
    description:
      'Полная миграция в Holded с модулем склада: клиенты, поставщики, счета, бухгалтерия, товары, артикулы, склады и начальные остатки. Включает интеграцию склада с выставлением счетов и приоритетную поддержку в течение 90 дней.',
    serviceType: 'Holded',
    provider: {
      '@type': 'Organization',
      name: 'EXPERT',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Миграция в Holded с инвентаризацией
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Полная миграция в Holded с модулем склада: клиенты, поставщики, счета, бухгалтерия,
            товары, артикулы, склады и начальные остатки. Включает интеграцию склада с выставлением
            счетов и приоритетную поддержку в течение 90 дней.
          </p>
