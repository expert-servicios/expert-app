...
const SERVICE_SLUG = 'constitucion-sl';
const ES_URL = 'https://expertconsulting.es/servicios/empresas-autonomos/constitucion-sl';
const RU_PATH = '/ru/uslugi/sozdanie-sl';
...
const service = (() => {
  ...
  if (!canonical?.stripePriceId || !canonical.price) {
    throw new Error('Canonical constitucion-sl service is not configured for checkout.');
  }
  return {
    ...canonical,
...
export const metadata: Metadata = {
  title: 'Создание SL (Sociedad Limitada) в Испании | EXPERT',
  description:
    `Полное сопровождение учреждения SL: название компании, устав, нотариальный акт, Registro Mercantil и постановка на налоговый учёт. ${service.price}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'Создание SL (Sociedad Limitada) | EXPERT',
    description: 'Устав, нотариальный акт, Registro Mercantil и NIF компании — под ключ.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const DURATION_RU = '7–15 рабочих дней';

const includes = [
  'Сертификат о названии компании (BORME)',
  'Разработка устава и договора участников',
  'Нотариальный акт (escritura pública)',
  'Регистрация в Registro Mercantil',
  'Постановка на налоговый учёт в Hacienda (Modelo 036)',
  'Получение окончательного NIF',
];

const faqs = [
  {
    q: 'Какой минимальный уставный капитал нужен?',
    a: 'От 1 евро, хотя на практике обычно вносят начальный капитал 3 000 €.',
  },
  {
    q: 'Можно ли учредить SL в одиночку?',
    a: 'Да, можно учредить SL с единственным участником (sociedad unipersonal).',
  },
];

export default function RuConstitucionSlPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Создание SL (Sociedad Limitada)',
    description:
      'Полное сопровождение учреждения испанской Sociedad Limitada: название компании, устав и договор участников, нотариальный акт, регистрация в Registro Mercantil и постановка на налоговый учёт.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            Создание SL (Sociedad Limitada)
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Сопровождаем весь процесс учреждения SL: подбор названия компании, разработку устава и договора
            участников, оформление нотариального акта, регистрацию в Registro Mercantil и постановку на
            налоговый учёт в Hacienda.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            />
            <Link
              href="/solicitar-presupuesto?servicio=constitucion-sl&tipo=caso-complejo"
