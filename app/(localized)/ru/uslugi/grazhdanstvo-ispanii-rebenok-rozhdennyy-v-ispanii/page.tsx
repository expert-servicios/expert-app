...
const documentGroups = [
  ...
  },
  {
    ...
    items: [
      'Свидетельство о рождении или о браке матери с её личной фамилией до брака, с официальным переводом и легализацией/апостилем, когда они требуются. Только если после проверки имеющихся документов нужно дополнительное подтверждение.',
      ...
      'Подписи законных представителей ребёнка в соответствии с конкретной семейной ситуацией.',
      'Дополнительные документы, если подписать заявление может только один из родителей.',
    ],
  },
];
...
const processSteps = [
  {
    title: 'Открытие дела и проверка документов',
    text: 'После оплаты EXPERT открывает expediente, сначала проверяет уже имеющиеся документы и запрашивает только то, чего действительно не хватает.',
  },
  {
    title: 'Представительство и легальная резиденция',
    text: 'Мы проверяем, кто должен действовать и подписывать за ребёнка, оформляем mandato EXPERT при необходимости и подтверждаем собственную легальную резиденцию ребёнка.',
  },
  {
    title: 'Фамилии для Registro Civil',
    text: 'До подготовки официальной формы проверяем происхождение фамилий, личную фамилию матери, возможную смену фамилии при браке и порядок фамилий. Удвоение одной фамилии не используется как способ избежать подтверждающих документов.',
  },
  {
    title: 'Официальная форма и подписи',
    text: 'Готовим корректную версию заявления и получаем необходимые подписи с учётом возраста ребёнка, patria potestad и представительства. Устаревшие версии формы больше не используются.',
  },
  {
    title: 'Финальная проверка и пошлина',
    text: 'Перед подачей проводим профессиональную проверку, убеждаемся, что 790-026 ещё не оплачена, при необходимости оплачиваем её как suplido и сохраняем justificante.',
  },
  {
    title: 'Подача и сопровождение',
    text: 'Подаём заявление только после финальной валидации, сохраняем подтверждение и номер регистрации и затем ведём дальнейшее сопровождение.',
  },
];
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Подготовка и подача заявления на испанское гражданство по резиденции для несовершеннолетнего ребёнка, родившегося в Испании. Мы проверяем срок легальной резиденции, непрерывность проживания, документы ребёнка и родителей, а также требования к подписи законных представителей.
          </p>
