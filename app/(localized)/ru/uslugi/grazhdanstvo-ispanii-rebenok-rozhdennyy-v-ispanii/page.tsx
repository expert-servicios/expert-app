...
const documentGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      'Подпись обоих родителей как законных представителей ребёнка.',
...
const processSteps = [
  ...
  },
  {
    ...
    text: 'После оплаты клиент отправляет необходимые документы через WhatsApp или по электронной почте.',
  },
  {
...
const faqItems = [
  ...
  },
  {
    ...
    a:
      'Если оба родителя осуществляют patria potestad, рекомендуется, чтобы заявление подписали оба родителя как законные представители ребёнка. Если подписать может только один родитель, мы отдельно проверяем документы, подтверждающие достаточные полномочия для представительства.',
  },
];
