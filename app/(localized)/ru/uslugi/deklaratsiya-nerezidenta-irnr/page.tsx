...
const SERVICE_SLUG = 'no-residentes';
const ES_URL = 'https://expertconsulting.es/servicios/declaraciones-impuestos/no-residentes';
const RU_PATH = '/ru/uslugi/deklaratsiya-nerezidenta-irnr';
...
if (!getCatalogService(SERVICE_SLUG)) {
  throw new Error('Canonical no-residentes service is missing from the catalog.');
}

const PRICE_RU = 'От 80 € + IVA / за форму';
...
export const metadata: Metadata = {
  title: 'IRNR — декларация нерезидента в Испании | EXPERT',
  description:
    `Декларация IRNR для нерезидентов с недвижимостью, инвестициями или доходами в Испании: Modelo 210, 211 и 213. ${PRICE_RU}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'IRNR — декларация нерезидента | EXPERT',
    description: 'Modelo 210, 211 и 213 для нерезидентов с имуществом или доходами в Испании.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  'Анализ вашей ситуации как нерезидента',
  'Подготовка Modelo 210 / 211 / 213',
  'Расчёт суммы налога и удержаний',
  'Электронная подача',
  'Консультация по соглашениям об избежании двойного налогообложения',
];

const faqs = [
  {
    q: 'Когда нужно подавать Modelo 210?',
    a: 'Это зависит от вида дохода и даты его возникновения. Orden HAC/623/2026 изменил сроки и установил отдельный переходный период на 2026 год, поэтому перед подачей мы всегда проверяем актуальный официальный срок.',
  },
  {
    q: 'Нужен ли мне налоговый представитель?',
    a: 'Само по себе то, что вы нерезидент или владеете недвижимостью в Испании, этого не требует. Такая обязанность возникает только в определённых случаях, предусмотренных законодательством — мы проверяем вашу ситуацию, прежде чем говорить об этом требовании.',
  },
];

export default function RuNoResidentesPage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'IRNR — декларация нерезидента',
    description:
      'Декларация IRNR для нерезидентов с недвижимостью, инвестициями или доходами испанского происхождения: Modelo 210, 211 и 213.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            IRNR — декларация нерезидента
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Если у вас есть недвижимость, инвестиции или доходы испанского происхождения, а налоговым
            резидентом Испании вы не являетесь, нужно подавать Impuesto sobre la Renta de No Residentes
            (IRNR) — налог на доходы нерезидентов. Готовим Modelo 210, 211 и 213 в зависимости от вашей ситуации.
          </p>
