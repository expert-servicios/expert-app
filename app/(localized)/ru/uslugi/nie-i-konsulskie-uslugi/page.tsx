...
const SERVICE_SLUG = 'nie-pasaporte';
const ES_URL = 'https://expertconsulting.es/servicios/extranjeria-nacionalidad/nie-pasaporte';
const RU_PATH = '/ru/uslugi/nie-i-konsulskie-uslugi';
...
if (!getCatalogService(SERVICE_SLUG)) {
  throw new Error('Canonical nie-pasaporte service is missing from the catalog.');
}

const PRICE_RU = 'От 60 € + IVA';
const DURATION_RU = '1–4 недели';

const budgetHref = `/solicitar-presupuesto?servicio=${SERVICE_SLUG}`;
const complexBudgetHref = `${budgetHref}&tipo=caso-complejo`;

export const metadata: Metadata = {
  title: 'NIE и консульские услуги в Испании | EXPERT',
  description:
    `Оформление NIE для граждан ЕС и не ЕС, а также консульские услуги: записи, документы для виз, справки о регистрации. ${PRICE_RU}.`,
  alternates: {
    canonical: RU_URL,
    languages: {
      'es-ES': ES_URL,
  ...
  openGraph: {
    title: 'NIE и консульские услуги | EXPERT',
    description: 'Получение NIE и сопровождение консульских процедур: записи, формы, форма EX-15.',
    url: RU_URL,
    type: 'website',
    locale: 'ru_RU',
    siteName: 'EXPERT',
...
const includes = [
  ...
  'Подготовка формуляров и документации',
  'Оформление формы Modelo EX-15',
  'Сопровождение при необходимости',
];

const faqs = [
  {
    q: 'Для чего мне нужен NIE?',
    a: 'Для подписания договоров, открытия банковских счетов, покупки недвижимости, трудоустройства или начала любой экономической деятельности в Испании.',
  },
];

export default function RuNiePasaportePage() {
  const serviceJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'NIE и консульские услуги',
    description:
      'Оформление Número de Identificación de Extranjero (NIE) для граждан ЕС и не ЕС, а также сопровождение консульских процедур: записи, документы для виз, справки о регистрации и другие процедуры в Испании.',
      ...
      <section className="bg-[#0D1B2A] px-6 py-12 text-[#F8F6F1] md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
            NIE и консульские услуги
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/65">
            Оформляем получение NIE (для граждан ЕС и не ЕС), а также ведём сопровождение по делам, связанным
            с консульством: записи, подготовка документов для виз, справки о регистрации и другие консульские
            процедуры в Испании.
          </p>
