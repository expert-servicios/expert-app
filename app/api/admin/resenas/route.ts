...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = admin
      .from('reviews')
      .select('id,case_id,client_id,rating,comment,allow_publish,status,published,featured,created_at,service_name,profiles!reviews_client_id_fkey(full_name,email:id)')
