...
const blueprints: ServiceOperationalBlueprint[] = [
  ...
  },
  {
    ...
    requirements: [
      { key: 'current_route', label: 'El supuesto familiar encaja en los supuestos vigentes de arraigo familiar', required: true, clientCheckable: false },
    ...
    documents: [
      ...
      { key: 'reference_person', label: 'Documentación de identidad y situación del familiar de referencia', required: true },
      { key: 'registration', label: 'Empadronamiento u otra prueba de convivencia cuando resulte relevante', required: false, conditionalWhen: 'El supuesto exige convivencia o residencia conjunta' },
    ],
