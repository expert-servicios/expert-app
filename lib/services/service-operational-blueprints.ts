  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        key: 'prepare',
        title: 'Preparación del expediente',
        description: 'Preparar solicitud, anexos y paquete documental una vez acreditada la representación.',
        clientVisible: true,
      },
      {
        key: 'fee',
    ...
    tasks: [
      ...
      },
      {
        ...
        description: 'Preparar formulario, anexos y paquete documental una vez validado el mandato.',
        priority: 'alta',
        phase: 'prepare',
        dueBusinessDays: 0,
