export const proteccionDatosBlogArticles = [
  {
    slug: 'rgpd-autonomos-pymes-espana-2026',
    category: 'Protección de datos',
    title: 'RGPD para autónomos y pymes en España: qué debes tener realmente en 2026',
    excerpt:
      'Las obligaciones esenciales de protección de datos para una pyme o autónomo: base jurídica, información, RAT, encargados, seguridad, derechos y brechas.',
    date: '24 sep 2026',
    readTime: '10 min',
...
**Fuentes revisadas el 24/09/2026.** Este artículo es informativo y no sustituye el análisis jurídico de un tratamiento concreto.
  ...
  {
    slug: 'web-formularios-cookies-rgpd-lssi-espana',
    category: 'Protección de datos',
    title: 'Web, formularios y cookies: cómo cumplir RGPD y LSSI en España',
    excerpt:
    ...
    date: '24 sep 2026',
    readTime: '9 min',
    tags: ['RGPD', 'LSSI', 'cookies', 'formularios web', 'privacidad', 'newsletter'],
    body: `
...
**Fuentes revisadas el 24/09/2026.** La configuración concreta depende de las tecnologías utilizadas por cada web.
  ...
  {
    slug: 'proveedores-cloud-ia-rgpd-encargados-tratamiento',
    category: 'Protección de datos',
    title: 'CRM, cloud, gestoría e IA: qué revisar antes de dar datos de clientes a un proveedor',
    excerpt:
      'Cómo distinguir responsable y encargado, qué debe contener el contrato del artículo 28 y qué revisar en subencargados y transferencias internacionales.',
    date: '24 sep 2026',
    readTime: '10 min',
    tags: ['encargado del tratamiento', 'cloud', 'IA', 'CRM', 'transferencias internacionales', 'RGPD'],
    body: `
...
**Fuentes revisadas el 24/09/2026.** La condición de responsable o encargado debe determinarse según las funciones efectivas de cada parte.
  ...
  {
    slug: 'brecha-datos-personales-72-horas-aepd',
    category: 'Protección de datos',
    title: 'Brecha de datos personales: qué hacer durante las primeras 72 horas',
    excerpt:
    ...
    date: '24 sep 2026',
    readTime: '9 min',
    tags: ['brecha de datos', 'AEPD', '72 horas', 'ciberseguridad', 'RGPD', 'incidentes'],
    body: `
