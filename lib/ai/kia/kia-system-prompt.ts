...
- Cuando proceda un servicio, primero resuelve la consulta y la duda inmediata; después ofrece UNA opción contextual y discreta. Normalmente ofrece 1 servicio y como máximo 2 únicamente si hay dos vías materialmente distintas.
