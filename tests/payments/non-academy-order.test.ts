...
describe('non-Academy order persistence', () => {
  ...
  it('separates a paid suplido from the professional gross amount', () => {
  ...
  it('preserves legacy catalog payments with no disbursements', () => {
  ...
  it('fails closed when a paid suplido has no accepted mandate', () => {
    expect(() => resolveCatalogPaymentBreakdown({
      amountTotalCents: 40655,
      revenueAmountCents: '25000',
      disbursementTotalCents: '10405',
